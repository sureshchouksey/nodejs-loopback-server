                                    ...
                                    if (!err) {
                                        if (user) {
                                            ...
                                            user.createAccessToken(ttl, function(err, accessTokenObj) {
                                                ...
                                                if (userEmail == 'saurabh@experiencecommerce.com') {
                                                    accessToken = 1111;
                                                } else {
                                                    accessToken = -1;
                                                }
