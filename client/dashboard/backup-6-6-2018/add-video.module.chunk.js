...
var AddVideoComponent = /** @class */ (function () {
    ...
    AddVideoComponent.prototype.videoValuechange = function () {
    ...
    AddVideoComponent.prototype.durationValuechange = function () {
    ...
    AddVideoComponent.prototype.submit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var validFlag, regExpYouTube, regExpVimeo, durationArr, key, uploadFlag1, dataArrObj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.name.valid && this.duration.valid && this.priority.valid && this.videoValid && this.durationValid)) return [3 /*break*/, 4];
                        uploadFlag1 = true;
