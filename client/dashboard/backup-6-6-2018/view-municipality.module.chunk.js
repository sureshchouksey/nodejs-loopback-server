webpackJsonp(["view-municipality.module"],{

/***/ "./src/app/pages/municipality/view-municipality/view-municipality-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewMunicipalityRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_municipality_component__ = __webpack_require__("./src/app/pages/municipality/view-municipality/view-municipality.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__view_municipality_component__["a" /* ViewMunicipalityComponent */],
        data: {
            title: 'View Book'
        }
    }
];
var ViewMunicipalityRoutingModule = /** @class */ (function () {
    function ViewMunicipalityRoutingModule() {
    }
    ViewMunicipalityRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"]]
        })
    ], ViewMunicipalityRoutingModule);
    return ViewMunicipalityRoutingModule;
}());
...
var ViewMunicipalityComponent = /** @class */ (function () {
    function ViewMunicipalityComponent(router, bookApi, _cookieService, _lightbox, confirmationService, appLoginApi, loopAuth, route, cityApi, municipalityApi) {
        this.router = router;
    ...
    ViewMunicipalityComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        var dataObj = {};
        var uid = this.id;
        ...
        this.municipalityApi.getMunicipality(dataArrObj).subscribe(function (data) {
            _this.loading = false;
            if (data.result.length > 0) {
                ...
                _this.municipalityData = data.result[0];
    ...
    ViewMunicipalityComponent.prototype.activeInactiveClick = function () {
        var _this = this;
    ...
    ViewMunicipalityComponent.prototype.activeInactiveSubmit = function () {
        var _this = this;
        this.loading = true;
        var dataObj = {};
        if (this.municipalityData['status'] == 'Active') {
            dataObj['status'] = 0;
        }
        else {
            dataObj['status'] = 1;
        ...
        var provinceObj = {
            city_id: this.id,
            city_name: this.municipalityData['city_name'],
    ...
    ViewMunicipalityComponent.prototype.open = function (data, index) {
        // override the default config
        this._lightbox.open(data, index, { wrapAround: true, showImageNumberLabel: true });
    };
    ViewMunicipalityComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "viewBook",
            template: __webpack_require__("./src/app/pages/municipality/view-municipality/view-municipality.component.html"),
    ...
    return ViewMunicipalityComponent;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewMunicipalityModule", function() { return ViewMunicipalityModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__view_municipality_component__ = __webpack_require__("./src/app/pages/municipality/view-municipality/view-municipality.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_municipality_routing_module__ = __webpack_require__("./src/app/pages/municipality/view-municipality/view-municipality-routing.module.ts");
...
var ViewMunicipalityModule = /** @class */ (function () {
    function ViewMunicipalityModule() {
    }
    ViewMunicipalityModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_5__view_municipality_routing_module__["a" /* ViewMunicipalityRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__view_municipality_component__["a" /* ViewMunicipalityComponent */]
            ]
        })
    ], ViewMunicipalityModule);
    return ViewMunicipalityModule;
}());
...
//# sourceMappingURL=view-municipality.module.chunk.js.map