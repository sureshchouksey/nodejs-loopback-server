...
/***/ "./src/app/pages/equipment/equipment/equipment-routing.module.ts":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__equipment_component__ = __webpack_require__("./src/app/pages/equipment/equipment/equipment.component.ts");
...
var EquipmentComponent = /** @class */ (function () {
    function EquipmentComponent(uApi, cityApi, _cookieService, router, loopAuth, _lightbox, equipmentApi) {
        this.uApi = uApi;
    ...
    EquipmentComponent.prototype.getCount = function () {
        var _this = this;
        this.loading = true;
        if (this.createdAt) {
    ...
    EquipmentComponent.prototype.paginate = function (event) {
        this.equipmentData = [];
    ...
    EquipmentComponent.prototype.searchData = function () {
        this.offset = 0;
    ...
    EquipmentComponent.prototype.resetPage = function () {
        this.offset = 0;
        this.paginationVal = false;
        this.createdByErrors = false;
        this.provinceStatus = "";
    ...
    EquipmentComponent.prototype.getData = function (dataArrObj) {
        var _this = this;
        this.loading = true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__equipment_component__ = __webpack_require__("./src/app/pages/equipment/equipment/equipment.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__equipment_routing_module__ = __webpack_require__("./src/app/pages/equipment/equipment/equipment-routing.module.ts");
    ...
    EquipmentModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__equipment_routing_module__["a" /* EquipmentRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__equipment_component__["a" /* EquipmentComponent */]
            ]
        })
    ], EquipmentModule);
