webpackJsonp(["add-municipality.module"],{

/***/ "./src/app/pages/municipality/add-municipality/add-municipality-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MunicipalityCrudRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_municipality_component__ = __webpack_require__("./src/app/pages/municipality/add-municipality/add-municipality.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__add_municipality_component__["a" /* AddMunicipalityComponent */],
        data: {
            title: 'Add Municipality'
        }
    }
];
var MunicipalityCrudRoutingModule = /** @class */ (function () {
    function MunicipalityCrudRoutingModule() {
    }
    MunicipalityCrudRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"]]
        })
    ], MunicipalityCrudRoutingModule);
    return MunicipalityCrudRoutingModule;
}());
...
var AddMunicipalityComponent = /** @class */ (function () {
    function AddMunicipalityComponent(loopAuth, http, _cookieService, books, router, containerApi, share, cityApi, municipalityApi) {
        ...
        this.municipalityApi = municipalityApi;
        this.display = false;
    ...
    AddMunicipalityComponent.prototype.submit = function (form) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var validFlag, dataArrObj, city_name, key, dataObj, totalCount_1;
            return __generator(this, function (_a) {
                ...
                if (form.valid) {
                    ...
                    if (form.value.cityName) {
                        city_name = this.cityNameData;
                        for (key in this.cityNameData) {
                        ...
                        this.ifNameExist(dataObj).then(function (count) {
                            ...
                            if (totalCount_1 > 0) {
                                _this.loading = false;
                                _this.display = true;
                                _this.result = 'Municipality name already exist.';
                            }
                            else {
                                _this.municipalityApi.upsert(dataObj).subscribe(function (data) {
                                    _this.loading = false;
                                    _this.display = true;
    ...
    AddMunicipalityComponent.prototype.ifNameExist = function (dataObj) {
        var _this = this;
    ...
    AddMunicipalityComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.getCity().then(function (data) {
            _this.loading = false;
        }, function (err) {
            _this.loading = true;
        });
    };
    AddMunicipalityComponent.prototype.getCity = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            try {
                _this.cityApi.find().subscribe(function (data) {
                    _this.cityNameData = [];
                    _this.cityNameData = data;
                    resolve(_this.cityNameData);
                }, function (err) {
                    _this.loading = false;
                    _this.display = false;
                    _this.result = 'Something went wrong.';
    ...
    AddMunicipalityComponent.prototype.capital_letter = function (str) {
        str = str.split(" ");
    ...
    AddMunicipalityComponent.prototype.goToListing = function () {
    ...
    ], AddMunicipalityComponent.prototype, "name", void 0);
    AddMunicipalityComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            template: __webpack_require__("./src/app/pages/municipality/add-municipality/add-municipality.component.html")
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["m" /* LoopBackAuth */], __WEBPACK_IMPORTED_MODULE_5__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4_angular2_cookie_core__["CookieService"], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["d" /* BooksApi */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["g" /* ContainerApi */], __WEBPACK_IMPORTED_MODULE_6__providers_share_service_share_service__["a" /* ShareService */], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["e" /* CityApi */], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["o" /* MunicipalityApi */]])
    ], AddMunicipalityComponent);
    return AddMunicipalityComponent;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddMunicipalityModule", function() { return AddMunicipalityModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__add_municipality_component__ = __webpack_require__("./src/app/pages/municipality/add-municipality/add-municipality.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__add_municipality_routing_module__ = __webpack_require__("./src/app/pages/municipality/add-municipality/add-municipality-routing.module.ts");
...
var AddMunicipalityModule = /** @class */ (function () {
    function AddMunicipalityModule() {
    }
    AddMunicipalityModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_5__add_municipality_routing_module__["a" /* MunicipalityCrudRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__add_municipality_component__["a" /* AddMunicipalityComponent */]
            ]
        })
    ], AddMunicipalityModule);
    return AddMunicipalityModule;
}());
...
//# sourceMappingURL=add-municipality.module.chunk.js.map