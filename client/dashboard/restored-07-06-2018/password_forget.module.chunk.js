...
var PasswordForgetComponent = /** @class */ (function () {
    ...
    PasswordForgetComponent.prototype.resetClick = function () {
        ...
        if (this.userEmMoN.valid && self.username.trim() != '') {
            ...
            this.display = true;
            this.success = false;
            this.result = 'Please enter valid email id.';
            this.loading = false;
        }
    };
    ...
    PasswordForgetComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_2__shared_loopback_sdk__["b" /* App_loginApi */], __WEBPACK_IMPORTED_MODULE_2__shared_loopback_sdk__["u" /* UserApi */], __WEBPACK_IMPORTED_MODULE_3_angular2_cookie_core__["CookieService"]])
