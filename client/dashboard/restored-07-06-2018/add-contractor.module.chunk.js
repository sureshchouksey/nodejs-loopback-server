...
var AddContractorComponent = /** @class */ (function () {
    ...
    function AddContractorComponent(loopAuth, http, _cookieService, books, router, containerApi, share, appDetailsApi, contractorApi, emailApi) {
    ...
    AddContractorComponent.prototype.capital_letter = function (str) {
    ...
    AddContractorComponent.prototype.emailChange = function () {
        this.emailValidate = true;
    };
    AddContractorComponent.prototype.submit = function (contractorForm) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var validFlag, uploadFlag1, contractorName_1, emailId_1;
            return __generator(this, function (_a) {
                this.submitted = true;
                validFlag = true;
                uploadFlag1 = true;
                if (contractorForm.valid) {
                    contractorName_1 = this.capital_letter(contractorForm.value.contractorName);
                    emailId_1 = (contractorForm.value.contractorEmailId != null && contractorForm.value.contractorEmailId != undefined && contractorForm.value.contractorEmailId != '') ? contractorForm.value.contractorEmailId.toLowerCase() : '';
                    this.loading = true;
                    this.emailApi.validateEmail({ "email_id": emailId_1 }).subscribe(function (result) {
                        _this.emailValidate = result.result.isValid;
                        if (_this.emailValidate) {
                            var contractorObj_1 = {
                                name_of_contractor: contractorName_1,
                                contractor_email_id: emailId_1,
                                contractor_photo: '',
                                app_id: (_this.contractorAppId.length > 0) ? _this.contractorAppId : [],
                                status: (_this.contractor_status) ? 'Active' : 'Inactive'
                            };
                            //console.log("form submited",contractorForm);
                            //console.log("form submited obj",contractorObj);
                            _this.ifNameExist(contractorObj_1).then(function (total) { return __awaiter(_this, void 0, void 0, function () {
                                var _this = this;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!(total > 0)) return [3 /*break*/, 1];
                                            this.loading = false;
                                            this.result = "Contractor email id already exist";
                                            this.display = true;
                                            return [3 /*break*/, 3];
                                        case 1: return [4 /*yield*/, this.contractorApi.add_contractor(contractorObj_1).subscribe(function () {
    ...
    AddContractorComponent.prototype.ifNameExist = function (dataObj) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            try {
                _this.contractorApi.getContractorEmailCount({ "contractor_email_id": dataObj.contractor_email_id }).subscribe(function (data) {
