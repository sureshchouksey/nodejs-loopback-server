...
var SubTypeOfHousingComponent = /** @class */ (function () {
    function SubTypeOfHousingComponent(uApi, subTypHousngApi, _cookieService, router, loopAuth, _lightbox, type_of_housing_api) {
        this.uApi = uApi;
    ...
    SubTypeOfHousingComponent.prototype.getTypeOfHousing = function () {
        var _this = this;
