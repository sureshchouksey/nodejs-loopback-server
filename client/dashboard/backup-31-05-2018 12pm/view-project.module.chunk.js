    ...
    ViewProjectComponent.prototype.ngOnInit = function () {
        ...
        this.projectApi.getProjects(dataArrObj).subscribe(function (projectData) {
            ...
            if (projectResult.work_group.length > 0) {
                _this.workGroupArr = [];
                var wrkGrpLength = projectResult.work_group.length;
                var wrkGrpEmptyCount = 0;
                ...
                console.log("count :", wrkGrpEmptyCount, "length :", wrkGrpLength);
                if (wrkGrpLength == wrkGrpEmptyCount) {
