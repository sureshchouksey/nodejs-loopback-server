webpackJsonp(["view-type-of-housing.module"],{

/***/ "./src/app/pages/type-of-housing/view-type-of-housing/view-type-of-housing-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewTypeOfHousingRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_type_of_housing_component__ = __webpack_require__("./src/app/pages/type-of-housing/view-type-of-housing/view-type-of-housing.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__view_type_of_housing_component__["a" /* ViewTypeOfHousingComponent */],
        data: {
            title: 'View Type of Housing'
        }
    }
];
var ViewTypeOfHousingRoutingModule = /** @class */ (function () {
    function ViewTypeOfHousingRoutingModule() {
    }
    ViewTypeOfHousingRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"]]
        })
    ], ViewTypeOfHousingRoutingModule);
    return ViewTypeOfHousingRoutingModule;
}());
...
/***/ "./src/app/pages/type-of-housing/view-type-of-housing/view-type-of-housing.component.html":
/***/ (function(module, exports) {

module.exports = "<p-growl [(value)]=\"msgs\"></p-growl>\r\n<div class=\"confirmPopup\">\r\n    <p-confirmDialog></p-confirmDialog>\r\n</div>\r\n<div class=\"overlay\" *ngIf=\"loading\">\r\n    <i class=\"fa fa-spinner fa-pulse fa-3x fa-fw contCenter\"></i> <span class=\"sr-only\">Loading...</span>\r\n</div>\r\n<div class=\"animated fadeIn\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-12\">\r\n            <div class=\"card\">\r\n                <div class=\"card-header topGroup\">\r\n                    <button type=\"button\" class=\"backBtn\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/type-of-housing']\">\r\n                        <i class=\"fa fa-angle-left\" aria-hidden=\"true\"></i> Back</button>\r\n                    <!-- <div class=\"btnGroup\">\r\n                        <button type=\"button\" class=\"btn\" (click)=\"activeInactiveClick()\">\r\n                            <i class=\"fa fa-ban fa-lg mt-4\"></i> {{provinceData['status']=='Active'?\"Inactivate Province\":\"Activate Province\"}}</button>\r\n                    </div> -->\r\n                </div>\r\n                <div class=\"detailsContainer productContainer\">\r\n                    <div class=\"card-details\">\r\n                        <div class=\"card-block\">\r\n                            <div class=\"blockTop productBlock\">\r\n                                <div class=\"items\">\r\n                                    <div class=\"gutter-space\">\r\n                                        <div class=\"panelWrapper\">\r\n                                            <div class=\"panelHead\">\r\n                                                <h3>Type of housing Details</h3>\r\n                                            </div>\r\n                                            <div class=\"panelBody\">\r\n                                                <ul class=\"panelitem panelInfo\">\r\n                                                    <li>\r\n                                                        <p>Type of Housing Name</p>\r\n                                                        <h4>{{typOfHusngData.type_of_housing || '0'}}</h4>\r\n                                                    </li>\r\n                                                    <li>\r\n                                                        <p>Type of Housing Status</p>\r\n                                                        <h4>{{typOfHusngData.status || '-'}}</h4>\r\n                                                    </li>\r\n\r\n                                                </ul>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),

/***/ "./src/app/pages/type-of-housing/view-type-of-housing/view-type-of-housing.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewTypeOfHousingComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
...
var ViewTypeOfHousingComponent = /** @class */ (function () {
    function ViewTypeOfHousingComponent(router, bookApi, _cookieService, _lightbox, confirmationService, appLoginApi, loopAuth, route, cityApi, typeOfHousingApi) {
        this.router = router;
    ...
    ViewTypeOfHousingComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        var dataObj = {};
        var uid = this.id;
        ...
        this.typeOfHousingApi.getTypeOfHousingStage(dataArrObj).subscribe(function (data) {
            ...
            if (data.result.length > 0) {
                ...
                _this.typOfHusngData = data.result[0];
    ...
    ViewTypeOfHousingComponent.prototype.activeInactiveClick = function () {
        var _this = this;
    ...
    ViewTypeOfHousingComponent.prototype.activeInactiveSubmit = function () {
        var _this = this;
        this.loading = true;
        var dataObj = {};
        if (this.typOfHusngData['status'] == 'Active') {
            dataObj['status'] = 0;
        }
        else {
            dataObj['status'] = 1;
        ...
        var provinceObj = {
            city_id: this.id,
            city_name: this.typOfHusngData['city_name'],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewTypeOfHousingModule", function() { return ViewTypeOfHousingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__view_type_of_housing_component__ = __webpack_require__("./src/app/pages/type-of-housing/view-type-of-housing/view-type-of-housing.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_type_of_housing_routing_module__ = __webpack_require__("./src/app/pages/type-of-housing/view-type-of-housing/view-type-of-housing-routing.module.ts");
...
var ViewTypeOfHousingModule = /** @class */ (function () {
    function ViewTypeOfHousingModule() {
    }
    ViewTypeOfHousingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_5__view_type_of_housing_routing_module__["a" /* ViewTypeOfHousingRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__view_type_of_housing_component__["a" /* ViewTypeOfHousingComponent */]
            ]
        })
    ], ViewTypeOfHousingModule);
    return ViewTypeOfHousingModule;
}());
...
//# sourceMappingURL=view-type-of-housing.module.chunk.js.map