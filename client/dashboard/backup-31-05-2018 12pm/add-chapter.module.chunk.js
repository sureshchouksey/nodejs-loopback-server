...
var AddChapterComponent = /** @class */ (function () {
    ...
    AddChapterComponent.prototype.initialData = function () {
        ...
        this.books.getBooks(dataArrObj1, null).subscribe(function (data) {
            if (data) {
        ...
        this.books.getHighestPriority("chapters", this.bookId).subscribe(function (data) {
            if (data) {
                _this.loading = false;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.name.valid && this.priority.valid) {
                    ...
                    this.loading = true;
                    this.books.addEditChapters(dataArrObj, null).subscribe(function (data) {
                        _this.loading = false;
                        if (data) {
                            console.log(data);
                            if (data.result.id > 0) {
