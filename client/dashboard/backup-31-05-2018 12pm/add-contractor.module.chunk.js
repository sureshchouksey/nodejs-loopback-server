            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        contractorObj_1 = {
                            name_of_contractor: this.capital_letter(contractorForm.value.contractorName),
                        ...
                        console.log("form submited obj", contractorObj_1);
