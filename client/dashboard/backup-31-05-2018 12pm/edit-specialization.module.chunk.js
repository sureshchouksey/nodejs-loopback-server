...
var EditSpecializationComponent = /** @class */ (function () {
    function EditSpecializationComponent(loopAuth, route, http, _cookieService, books, router, containerApi, share, cityApi, equipmentApi) {
    ...
    EditSpecializationComponent.prototype.submit = function (equipmentForm) {
