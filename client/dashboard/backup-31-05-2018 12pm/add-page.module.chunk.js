...
var AddPageComponent = /** @class */ (function () {
    ...
    AddPageComponent.prototype.initialData = function () {
        ...
        this.books.getChapters(dataArrObj, null).subscribe(function (data) {
            if (data) {
        ...
        this.books.getHighestPriority("pages", this.chapterId).subscribe(function (data) {
            _this.loading = false;
            if (data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.books.addEditPages(dataArrObj, null).subscribe(function (data) {
                            _this.loading = false;
                            if (data) {
                                if (data.result.id > 0) {
    ...
    AddPageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["k" /* LoopBackAuth */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"], __WEBPACK_IMPORTED_MODULE_5__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4_angular2_cookie_core__["CookieService"], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["d" /* BooksApi */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["g" /* ContainerApi */], __WEBPACK_IMPORTED_MODULE_6__providers_share_service_share_service__["a" /* ShareService */]])
    ], AddPageComponent);
