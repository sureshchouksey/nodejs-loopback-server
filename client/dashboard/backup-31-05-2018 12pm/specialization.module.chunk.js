...
var SpecializationComponent = /** @class */ (function () {
    function SpecializationComponent(uApi, cityApi, _cookieService, router, loopAuth, _lightbox, equipmentApi) {
        this.uApi = uApi;
    ...
    SpecializationComponent.prototype.getCount = function () {
        ...
        var dataArrObj = {
            "equipment_name": this.equipmentNameSearch,
            //"created_at":this.createdAtSearch,
            "status": this.provinceStatusSearch,
            "page": this.offset,
            "limit": this.perPageLimit
        };
        this.busy = this.equipmentApi.getEquipmentCount(dataArrObj).subscribe(function (data) {
    ...
    SpecializationComponent.prototype.addEquipment = function () {
        this.router.navigate(["equipment/add-equipment"]);
    };
    SpecializationComponent.prototype.getData = function (dataArrObj) {
        ...
        this._albums = [];
        this.busy = this.equipmentApi.getEquipment(dataArrObj).subscribe(function (data) {
            _this.loading = false;
            ...
            _this.equipmentData = data.result;
