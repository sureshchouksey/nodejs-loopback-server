            ...
            for (var i = 0; i < totalData; i++) {
                ...
                if (data.result[i].project_cover_photo) {
                    ...
                    if (img != undefined && img != null && img != '') {
                        ...
                        data.result[i].project_cover_photo = "";
                    }
                }
