...
var AddSubTypeOfHousingComponent = /** @class */ (function () {
    function AddSubTypeOfHousingComponent(loopAuth, http, _cookieService, books, router, containerApi, share, cityApi, subTypHousngApi) {
    ...
    AddSubTypeOfHousingComponent.prototype.getCity = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            try {
