        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.submitted = true;
                        if (!(this.name.valid && this.duration.valid && this.priority.valid)) return [3 /*break*/, 3];
                        uploadFlag1 = true;
                        this.loading = true;
