...
/***/ "./src/app/pages/province/province/province-routing.module.ts":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__province_component__ = __webpack_require__("./src/app/pages/province/province/province.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__province_component__["a" /* ProvinceComponent */],
        data: {
            title: 'Province'
        }
    }
];
var ProvinceRoutingModule = /** @class */ (function () {
...
/***/ "./src/app/pages/province/province/province.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"overlay\" *ngIf=\"loading\">\r\n    <i class=\"fa fa-spinner fa-pulse fa-3x fa-fw contCenter\"></i> <span class=\"sr-only\">Loading...</span>\r\n</div>\r\n<div class=\"animated fadeIn\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-12\">\r\n            <div class=\"card\">\r\n                <div class=\"addUser\">\r\n                    <button type=\"button\" (click)=\"addProvince()\" class=\"btn btnUser\">Add Province</button>\r\n                </div>\r\n                <div class=\"card-header\">\r\n                    Search\r\n                </div>\r\n                <div class=\"row\">\r\n                    <div class=\"col-md-12\">\r\n                        <div class=\"card-Wrapper\">\r\n                            <div class=\"card-block\">\r\n                                <div class=\"primaryDetails\">\r\n                                    <div class=\"row\">\r\n                                        <div class=\"col-md-4\">\r\n                                            <div class=\"form-group\">\r\n                                                <label>Province Name</label>\r\n                                                <input class=\"form-control\" [(ngModel)]=\"provinceName\" />\r\n                                            </div>\r\n                                        </div>\r\n                                        <div class=\"col-md-4\">\r\n                                            <div class=\"form-group\">\r\n                                                <label>Status</label>\r\n                                                <select name=\"provinceStatus\" class=\"form-control\" [(ngModel)]=\"provinceStatus\">\r\n                          <option value=\"\">All</option>\r\n                          <option value=\"1\">Active</option>\r\n                          <option value=\"0\">Inactive</option>\r\n                        </select>\r\n                                            </div>\r\n                                        </div>\r\n                                        <!-- <div class=\"col-md-4\">\r\n                                            <div class=\"form-group\">\r\n                                                <label>Created From</label>\r\n                                                <p-calendar name=\"createdAt\" [maxDate]=\"maxDate\" [readonlyInput]=\"true\" dateFormat=\"dd M yy\" [(ngModel)]=\"createdAt\"></p-calendar>\r\n                                            </div>\r\n                                        </div> -->\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"col-md-12\">\r\n                        <div class=\"buttonContainer\">\r\n                            <div class=\"form-group\">\r\n                                <!-- <label style=\"visibility:hidden;\">Search</label> -->\r\n                                <a href=\"javascript:;\" (click)=\"searchData()\" class=\"btn darkBtn\">Apply</a>\r\n                                <a href=\"javascript:;\" (click)=\"resetPage()\" class=\"btn darkBtn\">Reset</a>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"card\">\r\n                <div class=\"ui-g-12 ui-md-4\">\r\n                    Displaying <span>{{(offset==0)?1:(perPageLimit*(offset+1))-perPageLimit+1}} - {{(offset==0)?perPageLimit-(perPageLimit-provinceData?.length):perPageLimit*(offset+1)-(perPageLimit-provinceData?.length)}} of {{total}}</span>\r\n                </div>\r\n                <div class=\"card-Wrapper\">\r\n                    <div class=\"card-block\">\r\n                        <table class=\"table table-bordered productRequestTable\">\r\n                            <thead>\r\n                                <tr>\r\n                                    <th>Sr No.</th>\r\n                                    <th>Province Name</th>\r\n                                    <th>Province Status</th>\r\n                                    <th>Action</th>\r\n                                </tr>\r\n                            </thead>\r\n                            <tbody>\r\n                                <tr *ngFor=\"let province of provinceData; let i=index\">\r\n                                    <td>{{i+1+(offset?offset*10:0)}}</td>\r\n                                    <td>{{province.city_name || '-'}}</td>\r\n                                    <td>{{province.status || '-'}}</td>\r\n                                    <td>\r\n                                        <div class=\"groupBtn\">\r\n                                            <a class=\"btn btnEdit\" [routerLink]=\"['/province/view-province', province.city_id]\">View</a>\r\n                                            <a class=\"btn btnEdit\" [routerLink]=\"['/province/edit-province', province.city_id]\">Edit</a>\r\n                                        </div>\r\n                                    </td>\r\n                                </tr>\r\n                            </tbody>\r\n                        </table>\r\n                        <p-paginator class=\"paginCustome\" *ngIf=\"paginationVal\" rows=\"10\" totalRecords={{total}} (onPageChange)=\"paginate($event)\"></p-paginator>\r\n                    </div>\r\n                    <div class=\"card-block\" *ngIf=\"provinceData?.length==0\">\r\n                        <div class=\"row\">\r\n                            <div class=\"col-md-4\">&nbsp;</div>\r\n                            <div class=\"col-md-4\">\r\n                                <h4>NO RESULT FOUND</h4>\r\n                            </div>\r\n                            <div class=\"col-md-4\">&nbsp;</div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),

/***/ "./src/app/pages/province/province/province.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProvinceComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
...
var ProvinceComponent = /** @class */ (function () {
    function ProvinceComponent(uApi, cityApi, _cookieService, router, loopAuth, _lightbox) {
        this.uApi = uApi;
    ...
    ProvinceComponent.prototype.getCount = function () {
        var _this = this;
        this.loading = true;
        if (this.createdAt) {
        ...
        var dataArrObj = {
            "city_name": this.provinceNameSearch,
            //"created_at":this.createdAtSearch,
            "status": this.provinceStatusSearch,
            "page": this.offset,
            "limit": this.perPageLimit
        };
        this.busy = this.cityApi.getProvinceCount(dataArrObj).subscribe(function (data) {
    ...
    ProvinceComponent.prototype.paginate = function (event) {
        this.provinceData = [];
    ...
    ProvinceComponent.prototype.searchData = function () {
        this.offset = 0;
        this.paginationVal = false;
        this.ifEmpty = false;
        this.provinceData = [];
        this.provinceNameSearch = this.provinceName;
        //this.createdAtSearch = this.createdAt;
        this.provinceStatusSearch = this.provinceStatus;
        this.getCount();
    };
    ProvinceComponent.prototype.resetPage = function () {
        this.offset = 0;
        this.paginationVal = false;
        this.createdByErrors = false;
        this.provinceStatus = "";
    ...
    ProvinceComponent.prototype.addProvince = function () {
        this.router.navigate(["province/add-province"]);
    };
    ProvinceComponent.prototype.getData = function (dataArrObj) {
        var _this = this;
        this.loading = true;
        var loginFlagToken = this._cookieService.get(sdkPrefix + 'id');
        this._albums = [];
        this.busy = this.cityApi.getProvince(dataArrObj).subscribe(function (data) {
            _this.loading = false;
            ...
            _this.provinceData = data.result;
            console.log("provinceData", _this.provinceData);
        }, function (err) {
            _this.loading = false;
        }, function () { });
    };
    ...
    // 	return filtered;
    // }
    ProvinceComponent.prototype.open = function (index) {
        // open lightbox
        this._lightbox.open(this._albums, index, { positionFromTop: 60 });
    };
    ProvinceComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            template: __webpack_require__("./src/app/pages/province/province/province.component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__province_component__ = __webpack_require__("./src/app/pages/province/province/province.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__province_routing_module__ = __webpack_require__("./src/app/pages/province/province/province-routing.module.ts");
...
var ProvinceModule = /** @class */ (function () {
    ...
    ProvinceModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__province_component__["a" /* ProvinceComponent */]
            ]
        })
    ], ProvinceModule);
