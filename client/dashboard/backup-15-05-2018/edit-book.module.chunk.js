...
var EditBookComponent = /** @class */ (function () {
    ...
    EditBookComponent.prototype.ngOnInit = function () {
        ...
        this.busy = this.books.getBooks(dataArrObj).subscribe(function (data) {
            if (data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.submitted = true;
                        if (!(this.name.valid && this.description && this.priority.valid)) return [3 /*break*/, 3];
                        uploadFlag1 = true;
                    ...
                    case 2:
                        ...
                        this.busy = this.books.addEditBooks(dataArrObj, this.id).subscribe(function (data) {
                            if (data) {
                                console.log(data);
                                if (data.result.id > 0) {
