...
var EditPageComponent = /** @class */ (function () {
    ...
    EditPageComponent.prototype.ngOnInit = function () {
        ...
        this.busy = this.books.getPages(dataArrObj).subscribe(function (data) {
            if (data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.busy = this.books.addEditPages(dataArrObj, this.id).subscribe(function (data) {
                            _this.loading = false;
                            if (data) {
