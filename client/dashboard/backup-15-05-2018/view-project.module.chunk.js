...
var ViewProjectComponent = /** @class */ (function () {
    ...
    ViewProjectComponent.prototype.ngOnInit = function () {
        ...
        this.busy = this.projectApi.getProjects(dataArrObj).subscribe(function (data) {
            _this._albums = [];
            if (data.result.length > 0) {
                ...
                if (data.result[0].project_cover_photo) {
                    ...
                    data.result[0].project_cover_photo = "http://phapi.experiencecommerce.com:4500/api/containers/projectImage/download/" + img + '?access_token=' + _this.loginFlagToken;
                    _this._albums.push({
