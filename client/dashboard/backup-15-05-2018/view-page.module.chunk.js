...
var ViewPageComponent = /** @class */ (function () {
    ...
    ViewPageComponent.prototype.ngOnInit = function () {
        ...
        this.busy = this.pageApi.getPages(dataArrObj).subscribe(function (data) {
    ...
    ViewPageComponent.prototype.activeInactiveSubmit = function () {
        ...
        var pageId = this.id;
        this.msgs.length = 0;
        this.busy = this.pageApi.addEditPages(dataObj, pageId).subscribe(function (respData) {
