...
var ViewContractorComponent = /** @class */ (function () {
    ...
    ViewContractorComponent.prototype.ngOnInit = function () {
        ...
        this.loading = true;
        this.getContractorData().then(function (contractorResult) {
        ...
        // this.busy=this.bookApi.getBooks(dataArrObj).subscribe(
        // 	data=>{
        ...
        // 				data.result[0].created_at = moment(data.result[0].created_at).format("DD - MMM - YYYY");
        // 			}
                ...
                _this.contratorProfileApi.get_contractor_details(contractorObj).subscribe(function (data) {
                    ...
                    for (var key in _this.contractorDetails) {
                        ...
                        if (key == 'credentials') {
                            if (_this.contractorDetails[key] != '') {
                                ...
                                _this.credentialValue = credentialsArr;
                            }
                        }
                    ...
                    if (data.data.workGroup.length > 0) {
                        for (var key in data.data.workGroup) {
                            ...
                            var wrkGropNames = JSON.parse(data.data.workGroup[key].member_name);
                            var wrkGrpObj = {
                                memter_type: wrkGrpType,
                                members_name: wrkGropNames
                            };
                            _this.workGroup.push(wrkGrpObj);
                        }
                        console.log("workGroup ", _this.workGroup);
                    }
