...
var EditAffiliationComponent = /** @class */ (function () {
    ...
    EditAffiliationComponent.prototype.ngOnInit = function () {
        ...
        this.affiliationApi.getAffiliation(dataArrObj).subscribe(function (data) {
            if (data) {
                ...
                //console.log("contractorCount ",this.contractorCount);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (affiliationForm.valid) {
                    ...
                    this.ifNameExist(this.editAffiliation).then(function (total) {
                        if (total > 0) {
                            _this.loading = false;
                            ...
                            _this.checkCount(_this.editAffiliation).then(function (total) {
                                if (total > 0 && !_this.editAffiliation.status) {
                                    _this.loading = false;
                                    _this.result = "Affiliation is already been used so it cannot be inactive";
                                    _this.display = true;
                                }
                                else {
                                    _this.affiliationApi.upsertPatch(_this.editAffiliation).subscribe(function (data) {
                                        _this.loading = false;
    ...
    EditAffiliationComponent.prototype.ifNameExist = function (dataObj) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                _this.affiliationApi.getAffiliationCountName({ "certificate_name": dataObj.certificate_name, "status": dataObj.status }).subscribe(function (data) {
    ...
    EditAffiliationComponent.prototype.checkCount = function (dataObj) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            try {
                var access_token = _this.loopAuth.getAccessTokenId();
                var certificate_id = dataObj.certificate_id;
                var cond = { "certificate_id": certificate_id };
                var api = "/api/contractor_affiliation_mappings/count?where=";
