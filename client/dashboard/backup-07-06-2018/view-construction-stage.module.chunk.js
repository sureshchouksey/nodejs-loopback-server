webpackJsonp(["view-construction-stage.module"],{

/***/ "./src/app/pages/construction-stage/view-construction-stage/view-construction-stage-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewConstructionStageRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_construction_stage_component__ = __webpack_require__("./src/app/pages/construction-stage/view-construction-stage/view-construction-stage.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__view_construction_stage_component__["a" /* ViewConstructionStageComponent */],
        data: {
            title: 'View Equipment'
        }
    }
];
var ViewConstructionStageRoutingModule = /** @class */ (function () {
    function ViewConstructionStageRoutingModule() {
    }
    ViewConstructionStageRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"]]
        })
    ], ViewConstructionStageRoutingModule);
    return ViewConstructionStageRoutingModule;
}());
...
var ViewConstructionStageComponent = /** @class */ (function () {
    function ViewConstructionStageComponent(router, bookApi, _cookieService, _lightbox, confirmationService, appLoginApi, loopAuth, route, cityApi, constStgApi) {
        this.router = router;
    ...
    ViewConstructionStageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        var dataObj = {};
        var uid = this.id;
        ...
        this.constStgApi.getConstructionStage(dataArrObj).subscribe(function (data) {
            ...
            if (data.result.length > 0) {
                ...
                _this.constStgData = data.result[0];
                _this.projectCount = data.result[0].usedProjects;
            }
        }, function (err) {
            _this.loading = false;
        });
    };
    ViewConstructionStageComponent.prototype.activeInactiveClick = function () {
        var _this = this;
    ...
    ViewConstructionStageComponent.prototype.activeInactiveSubmit = function () {
        var _this = this;
        this.loading = true;
        var dataObj = {};
        if (this.constStgData['status'] == 'Active') {
            dataObj['status'] = 0;
        }
        else {
            dataObj['status'] = 1;
        ...
        var provinceObj = {
            city_id: this.id,
            city_name: this.constStgData['city_name'],
    ...
    ViewConstructionStageComponent.prototype.open = function (data, index) {
        // override the default config
        this._lightbox.open(data, index, { wrapAround: true, showImageNumberLabel: true });
    };
    ViewConstructionStageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "viewConstructionStage",
            template: __webpack_require__("./src/app/pages/construction-stage/view-construction-stage/view-construction-stage.component.html"),
    ...
    ], ViewConstructionStageComponent);
    return ViewConstructionStageComponent;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewConstructionStageModule", function() { return ViewConstructionStageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__view_construction_stage_component__ = __webpack_require__("./src/app/pages/construction-stage/view-construction-stage/view-construction-stage.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_construction_stage_routing_module__ = __webpack_require__("./src/app/pages/construction-stage/view-construction-stage/view-construction-stage-routing.module.ts");
...
var ViewConstructionStageModule = /** @class */ (function () {
    function ViewConstructionStageModule() {
    }
    ViewConstructionStageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_5__view_construction_stage_routing_module__["a" /* ViewConstructionStageRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__view_construction_stage_component__["a" /* ViewConstructionStageComponent */]
            ]
        })
    ], ViewConstructionStageModule);
    return ViewConstructionStageModule;
}());
...
//# sourceMappingURL=view-construction-stage.module.chunk.js.map