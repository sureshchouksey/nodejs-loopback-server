...
var AddBookComponent = /** @class */ (function () {
    ...
    AddBookComponent.prototype.initialData = function () {
        var _this = this;
        this.loading = true;
        this.books.getHighestPriority("books", null).subscribe(function (data) {
            _this.loading = false;
            if (data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        uploadFlag1 = true;
                        if (!(this.allData != "" && this.allData != undefined && this.allData.length > 0)) return [3 /*break*/, 2];
                    ...
                    case 3:
                        ...
                        if (validFlag) {
                            this.loading = true;
                            this.books.addEditBooks(dataArrObj, null).subscribe(function (data) {
                                _this.loading = false;
                                if (data) {
                                    //console.log(data);
                                    if (data.result.id > 0) {
