...
var BooksComponent = /** @class */ (function () {
    ...
    BooksComponent.prototype.ngOnInit = function () {
        this.bookStatus = this.bookStatusSearch = 1;
        this.getCount();
    };
    BooksComponent.prototype.getCount = function () {
        ...
        this.loading = true;
        if (this.createdAt) {
            this.createdAtSearch = __WEBPACK_IMPORTED_MODULE_3_moment__(this.createdAt).format("YYYY-MM-DD") + " 00:00:00.000";
        }
        var dataArrObj = {
    ...
    BooksComponent.prototype.getData = function (dataArrObj) {
        ...
        this.busy = this.booksApi.getBooks(dataArrObj).subscribe(function (data) {
            ...
            for (var i = 0; i < totalData; i++) {
                ...
                if (data.result[i].created_at) {
                    data.result[i].created_at = __WEBPACK_IMPORTED_MODULE_3_moment__(data.result[i].created_at).format("DD - MMM - YYYY");
                }
                else {
