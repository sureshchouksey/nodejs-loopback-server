...
var ViewBookComponent = /** @class */ (function () {
    ...
    ViewBookComponent.prototype.ngOnInit = function () {
        ...
        this.busy = this.bookApi.getBooks(dataArrObj).subscribe(function (data) {
    ...
    ViewBookComponent.prototype.getCount = function () {
        ...
        this.busy = this.bookApi.getChaptersCount(dataArrObj).subscribe(function (data) {
    ...
    ViewBookComponent.prototype.activeInactiveSubmit = function () {
        ...
        var bookId = this.id;
        this.msgs.length = 0;
        this.busy = this.bookApi.addEditBooks(dataObj, bookId).subscribe(function (respData) {
