webpackJsonp(["add-book.module"],{

/***/ "./src/app/pages/books/add-book/add-book-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BookCrudRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_book_component__ = __webpack_require__("./src/app/pages/books/add-book/add-book.component.ts");
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__add_book_component__["a" /* AddBookComponent */],
        data: {
            title: 'Add Book'
        }
    }
];
var BookCrudRoutingModule = /** @class */ (function () {
    function BookCrudRoutingModule() {
    }
    BookCrudRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"].forChild(routes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"]]
        })
    ], BookCrudRoutingModule);
    return BookCrudRoutingModule;
}());
...
var AddBookComponent = /** @class */ (function () {
    function AddBookComponent(loopAuth, http, _cookieService, books, router, containerApi, share) {
    ...
    AddBookComponent.prototype.initialData = function () {
        var _this = this;
        this.busy = this.books.getHighestPriority("books", null).subscribe(function (data) {
            if (data) {
                if (data.result.length == 1) {
                    console.log("priority data", data);
                    var priorityVal = data.result[0].priority;
                    _this.bookPriority = priorityVal + 1;
                }
            }
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.submitted = true;
                        validFlag = true;
                        if (!(this.name.valid && this.priority.valid)) return [3 /*break*/, 4];
                        uploadFlag1 = true;
                    ...
                    case 3:
                        ...
                        if (validFlag) {
                            this.busy = this.books.addEditBooks(dataArrObj, null).subscribe(function (data) {
                                if (data) {
                                    console.log(data);
                                    if (data.result.id > 0) {
    ...
    AddBookComponent.prototype.goToListing = function () {
        // window.location.reload();
        this.router.navigate(["books"]);
    };
    AddBookComponent.prototype.onFileChange = function (file) {
        var _this = this;
    ...
    AddBookComponent.prototype.uploadImage = function (fdata) {
        var _this = this;
    ...
    ], AddBookComponent.prototype, "name", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('priority'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__angular_forms__["NgModel"])
    ], AddBookComponent.prototype, "priority", void 0);
    AddBookComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            template: __webpack_require__("./src/app/pages/books/add-book/add-book.component.html")
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["e" /* LoopBackAuth */], __WEBPACK_IMPORTED_MODULE_5__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4_angular2_cookie_core__["CookieService"], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["c" /* BooksApi */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_3__shared_loopback_sdk__["d" /* ContainerApi */], __WEBPACK_IMPORTED_MODULE_6__providers_share_service_share_service__["a" /* ShareService */]])
    ], AddBookComponent);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddBooksModule", function() { return AddBooksModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__("./node_modules/@angular/http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__add_book_component__ = __webpack_require__("./src/app/pages/books/add-book/add-book.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__add_book_routing_module__ = __webpack_require__("./src/app/pages/books/add-book/add-book-routing.module.ts");
...
var AddBooksModule = /** @class */ (function () {
    function AddBooksModule() {
    }
    AddBooksModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_5__add_book_routing_module__["a" /* BookCrudRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__add_book_component__["a" /* AddBookComponent */]
            ]
        })
    ], AddBooksModule);
    return AddBooksModule;
}());
...
//# sourceMappingURL=add-book.module.chunk.js.map